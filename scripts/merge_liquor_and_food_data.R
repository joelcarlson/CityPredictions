...
# unite files
liquor_licenses <- read.csv("~/Documents/github/CityPredictions/data/Liquor/liquor_licenses.csv", stringsAsFactors=FALSE)
food_ins_criticalFlags <- read.csv("~/Documents/github/CityPredictions/data/FoodService/food_ins_criticalFlags.csv", stringsAsFactors=FALSE)
food_ins_grades <- read.csv("~/Documents/github/CityPredictions/data/FoodService/food_ins_grades.csv", stringsAsFactors=FALSE)
